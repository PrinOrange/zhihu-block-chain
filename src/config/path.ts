...
export default class PathConfig {
  ...
  static readonly resourcePath = path.resolve(
  ...
  static readonly outputPath = path.resolve(
    PathConfig.rootPath,
    "知乎助手输出的电子书"
  );
  ...
  // package.json文件
  static readonly packageJsonUri = path.resolve(
    PathConfig.rootPath,
    "package.json"
  );
  ...
  static readonly runtimeLogUri = path.resolve(
    PathConfig.rootPath,
    "runtime.log"
  );
